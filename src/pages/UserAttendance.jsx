        ...
        <div className="absolute top-0 left-0 w-full h-full bg-gray-900 bg-opacity-50 flex justify-center items-center z-10">
          <div className="bg-gray-700 rounded-lg p-8 w-120">
           ...
           <div className="flex flex-col justify-center items-center">
            <div className="px-4 py-2 whitespace-nowrap text-sm md:text-base text-gray-100 flex justify-center text-center">
              {userData.photoURL ? (
                <a
                ...
                >
                  <div class="rounded-full h-20 w-20 justify-evenly items-center mb-2">
                    <img
            ...
            <div className="flex items-center mb-6">
              <h1 className="text-2xl font-semibold text-orange-500 capitalize">
                {userData.name}
              </h1>
            </div>
            </div>
